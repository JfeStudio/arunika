    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <form method="post" action="{{ route('challenges.store') }}"
            ...
            <div class="lg:basis-4/12">
                <div class="mb-5">
                    ...
                    <select id="fee" name="fee"
                        ...
                        <option selected disabled>Free / Premium</option>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="markup" name="markup" value="{{ old('markup') }}"
            ...
            <div class="lg:basis-4/12">
                <div class="mb-5">
                    ...
                    <select id="styling" name="styling"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected disabled>Format Styling</option>
                ...
                <div class="mb-5">
                    ...
                    <select id="language" name="language"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected disabled>Format Language</option>
                ...
                <div class="mb-5">
                    ...
                    <select id="mode" name="mode"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected disabled>Format Mode</option>
            ...
            <div class="lg:basis-3/12">
                <div class="mb-5">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Preview
                        Mockup</label>
                    <input
                ...
                <div
                    class="@error('description') textarea-error @enderror mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
