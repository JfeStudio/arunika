        ...
        <div id="accordion-color" class="w-3/4 m-auto" data-accordion="collapse"
            ...
            <h2 id="accordion-color-heading-1">
                <button type="button"
                    ...
                    <span>Bisakah saya menggunakan perpustakaan/kerangka kerja pada proyek ini?
                    </span>
            ...
            <h2 id="accordion-color-heading-2">
                <button type="button"
                    ...
                    <span>Bagaimana saya bisa mendapatkan bantuan jika saya terjebak pada tantangan?</span>
            ...
            <h2 id="accordion-color-heading-3">
                <button type="button"
                    ...
                    <span>Bisakah saya menggunakan proyek-proyek ini dalam portofolio saya?</span>
                    <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
            ...
            <h2 id="accordion-color-heading-4">
                <button type="button"
                    ...
                    <span>Apakah ada solusi resmi yang bisa saya lihat?</span>
                    <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
            ...
            <h2 id="accordion-color-heading-5">
                <button type="button"
                    ...
                    <span>Apakah saya mendapatkan tinjauan kode ketika saya memposting solusi saya?</span>
                    <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
